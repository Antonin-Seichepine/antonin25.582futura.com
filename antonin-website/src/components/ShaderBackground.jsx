// ShaderBackground — 21st.dev Shader Builder ("Mesh drift"), palette Anton1.
// Aucune dépendance : un canvas WebGL qui remplit son parent.
...
// Charte Anton1 : trois neutres clairs, le coral #f4737a en quatrième position
// pour qu'il ne dérive que par touches.
const UNIFORMS = {
  colors: [
    [0.0863, 0.0745, 0.0588], // #16130f encre
    [0.9569, 0.4510, 0.4784], // #f4737a coral
    [0.1686, 0.1373, 0.1255], // #2b2320 encre chaude
    [0.9569, 0.4510, 0.4784], // #f4737a coral (2e foyer : le coral domine)
    [0.0863, 0.0745, 0.0588],
    [0.0863, 0.0745, 0.0588],
    [0.0863, 0.0745, 0.0588],
    [0.0863, 0.0745, 0.0588],
  ],
...
export function ShaderBackground({ className }) {
  ...
  useEffect(() => {
    ...
    // Fond figé si l'utilisateur a demandé moins de mouvement.
    const reduced =
      window.matchMedia &&
